...
namespace ZdravoKorporacija.ModelHCI
{
    class ArticleData
    {
        public static List<ArticleHCI> allArticles = new List<ArticleHCI>();
        public ArticleData()
        {
            ArticleHCI oneArticle1 = new ArticleHCI();
            ...
            oneArticle1.articlePic = new BitmapImage(new Uri("/Resources/apples.jpg", UriKind.Relative));
            allArticles.Add(oneArticle1);
            ArticleHCI oneArticle2 = new ArticleHCI();
            ...
            oneArticle2.articlePic = new BitmapImage(new Uri("/Resources/altmed.jpg", UriKind.Relative));
            allArticles.Add(oneArticle2);
            ArticleHCI oneArticle3 = new ArticleHCI();
            ...
            oneArticle3.articlePic = new BitmapImage(new Uri("/Resources/keto.jpg", UriKind.Relative));
            allArticles.Add(oneArticle3);
        }
    }
}
